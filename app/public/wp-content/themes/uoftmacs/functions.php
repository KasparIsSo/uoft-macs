...
function uoftmacs_script_enqueue(){
  ...
  if(is_page_template( 'research-and-fieldwork.php' )){ 
    wp_enqueue_style('research-and-fieldwork', get_template_directory_uri() . '/css/research-and-fieldwork.css', array(), '1.0.0', 'all');
  }
...
function uoftmacs_theme_setup(){
  ...
  register_nav_menu('primary-mobile', 'Primary Header Navigation - Mobile');
